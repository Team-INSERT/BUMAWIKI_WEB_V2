...
import includeFrame from './document/includeFrame'

export { asideFormat, autoClosingTag, dateParser, dateUTCParser, documentation, getLastDate, typeEditor, onKeyDownUseTab, getAllYear, includeFrame }
