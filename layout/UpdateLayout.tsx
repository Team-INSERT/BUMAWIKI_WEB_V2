        ...
        <S.DocsContentsWrap>
          <S.AutoCompleteToggleWrap onClick={onClickAutoComplete}>
            ...
            <S.AutoCompleteToggleButton
              color={isOnAutoComplete ? theme.primary : theme.white}
            >
              <Image src={Check} alt="" />
            </S.AutoCompleteToggleButton>
          ...
          <S.UpdateTextarea
            ...
            onChange={(e) =>
              setDocs(
                isOnAutoComplete
                  ? { ...docs, contents: util.autoClosingTag(e) }
                  : { ...docs, contents: e.target.value },
              )
            }
          ...
          <S.UpdateSubmit>
            ...
            <S.UpdateButton onClick={onClickUpdateDocs}>
              문서 업데이트
            </S.UpdateButton>
          </S.UpdateSubmit>
        </S.DocsContentsWrap>
