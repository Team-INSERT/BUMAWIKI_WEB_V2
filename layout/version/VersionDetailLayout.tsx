      ...
      <Board>
        ...
        <S.VersionContentsWrap>
          <S.VersionContentsLoadWrap>
            <S.LastUpdateDate>
              작성자 : {different.versionDocs.nickName}
            </S.LastUpdateDate>
            <S.LastUpdateDate>
              마지막 수정 :{" "}
              {util.dateParser(different.versionDocs.thisVersionCreatedAt)}
            </S.LastUpdateDate>
              ...
              {different.diff.map(({ operation, text }, index) => {
                ...
                return (
                  <S.VersionContentsContainer color={version.color} key={index}>
                    <S.VersionContentsIconBox color={version.color}>
                      {version.text}
                    </S.VersionContentsIconBox>
                    <S.VersionContents color={version.color}>
                      {decodeContents(text)}
                    </S.VersionContents>
