  ...
  return (
    <S.CreateWrap>
      <Board>
        ...
        <S.CreateTB>
          <S.CreateTableBody>
            <S.CreateTR>
              ...
              <S.CreateTDDisplay>
                {userInfo.authority === "ADMIN" && (
                  <>
                    <S.CreateTableLabel htmlFor="STUDENT">
                      학생
                    </S.CreateTableLabel>
                    <S.CreateTableRadio
                      type="radio"
                      onChange={(e) => changeDocsType(e)}
                      id="STUDENT"
                      name="radio"
                    />
                    <S.CreateTableLabel htmlFor="READONLY">
                      관리자
                    </S.CreateTableLabel>
                    <S.CreateTableRadio
                      type="radio"
                ...
                {createForm.map((info) => (
                  <S.CreateTableRadioBox key={info.id}>
                    <S.CreateTableLabel htmlFor={info.id}>
                      {info.title}
                    </S.CreateTableLabel>
                    <S.CreateTableRadio
                      type="radio"
            ...
            <S.CreateTR>
              ...
              <S.CreateTD>
                <S.CreateTableTRInputContents
                  onChange={(e) => setDocs({ ...docs, title: e.target.value })}
                  value={docs.title}
                />
              </S.CreateTD>
            </S.CreateTR>
                ...
                {years.map((year) => (
                  <S.CreateTableDiv key={year}>
                    ...
                    <S.CreateTableRadio
                      type="radio"
                      onChange={(e) =>
                        setDocs({ ...docs, enroll: parseInt(e.target.id) })
                      }
                      id={`${year}`}
                      name="radios"
                    />
                    ...
                    <S.FrameInputBox>
                      <S.FrameInputWrap>
                        ...
                        <S.FrameInput
                          ...
                          value={size.row}
                          onChange={(e) =>
                            setSize({ ...size, row: parseInt(e.target.value) })
                          }
                        />
                      </S.FrameInputWrap>
                    </S.FrameInputBox>
                    <S.CreateFrameButton onClick={makeFrame}>
                      틀생성/초기화
                    </S.CreateFrameButton>
                  </S.FrameWrap>
                </S.CreateTD>
            ...
            <S.CreateTR>
              ...
              <S.CreateTD>
                <S.CreateTableTRTextarea
                  ...
                  onChange={(e) =>
                    setDocs({ ...docs, contents: util.autoClosingTag(e) })
                  }
                  value={docs.contents}
                />
              </S.CreateTD>
        ...
        <S.CreateSubmit>
          <S.CreateWarn>
            ※ 필독! 문서 내 부적절한 내용을 서술하는 사용자는 부마위키 이용에
            제한을 받을 수 있습니다 ※
          </S.CreateWarn>
